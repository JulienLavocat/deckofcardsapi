...
function listPile(deckId, pileName) {
    return axios.get(`${host}/api/deck/${deckId}/pile/${pileName}/list`);
}
...
function pileDraw(deckId, pileName, count) {
    return axios.get(`${host}/api/deck/${deckId}/pile/${pileName}/draw/?count=${count}`);
}
function pileDrawCards(deckId, pileName, cards) {
    return axios.get(`${host}/api/deck/${deckId}/pile/${pileName}/draw/?cards=${cards}`);
}
function pileDrawBottom(deckId, pileName, count) {
    return axios.get(`${host}/api/deck/${deckId}/pile/${pileName}/draw/bottom/?count=${count}`);
}
